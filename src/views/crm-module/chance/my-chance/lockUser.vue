<template>
  <div class="Locked-customers">
    ...
    <div class="btn-wrapper">
      ...
      <el-button size="small" @click="handleDeLayLock">延长锁定</el-button>
    </div>
    <rd-table
      :tableData="tableData"
      :tableKey="tableKey"
  ...
  methods: {
    handleDeLayLock(){
      if(!this.selectedData.length){
        this.$message.warning("请勾选要延长锁定的机会！")
        return;
      }
      this.$confirm(
        `<strong> 确定要延长锁定所选机会吗？</strong>`,
        "提示",
        {
        ...
        .then(async () => {
          this.$fetch("chance_my_delaylock",{
