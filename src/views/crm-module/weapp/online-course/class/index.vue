...
<template>
    <div class='class-container'>
        ...
        <fullDialog class="subject" v-model="subjectVisiable" title="查阅科目" @change="subjectVisiable = false">
            <subject :classId="subjectClassId" @close="addEditVisible = false" @refresh="refresh" v-if="subjectVisiable"></subject>
        </fullDialog>
    </div>
</template>
...
import subject from '@/views/crm-module/weapp/online-course/subject/subject'
...
export default {
    ...
    components: { fullDialog, addEditClass, subject },
    computed: {
    ...
    methods: {
        ...
        handleSubject(data) {
            ...
            this.subjectClassId = data.courseClassId
            scrollTo(0, 800);
        },
        handleDelete(data) {
            let info = "班级"
