    ...
    >
      <div class="param-item">
        ...
        >
          ...
          <el-select v-model="dynamicValidateForm.project" size="small" placeholder="请选择" style="width: 300px">
      ...
      <div class="param-item">
        ...
        >
          ...
          <!--<span style="margin-right: 5px;font-weight:bold">:</span>-->
          <el-input v-model="dynamicValidateForm.subjectName" readonly size="small" style="width: 300px"></el-input>
        </el-form-item>
      </div>
      <div class="param-item">
        <el-form-item
        ...
        >
          <!--<div class="param-label">科目</div>-->
          <!--<span style="margin-right: 5px;font-weight:bold">:</span>-->
          <el-input v-model="dynamicValidateForm.subjectNumber" readonly size="small" style="width: 300px"></el-input>
        </el-form-item>
      </div>
      <div class="param-item">
        <el-form-item
          label="理论考试时间" prop="testTime"
          :rules="{
            required: true,
            message: '不能为空',
            trigger: 'blur',
        ...
        >
          ...
          <el-date-picker size="small"
                          v-model="dynamicValidateForm.testTime"
                          type="datetimerange"
                          range-separator="至"
      ...
      <div class="param-item" v-if="dynamicValidateForm.checked1">
        ...
        >
          ...
          <!--<span style="margin-right: 5px;font-weight:bold">:</span>-->
          <el-date-picker size="small"
                          v-model="dynamicValidateForm.tectestTime"
                          type="datetimerange"
                          range-separator="至"
                          start-placeholder="开始时间"
                          end-placeholder="结束时间">
      ...
      <div class="param-item" v-if="dynamicValidateForm.checked2">
        <el-form-item
          label="理论二考时间" prop="secondtestTime"
          :rules="{
            required: true,
            message: '不能为空',
            trigger: 'blur',
      ...
      <div class="param-item"  v-if="dynamicValidateForm.checked2">
        <el-form-item
          label="理论二考关考时间" prop="secondEndTime"
          :rules="{
            required: true,
            message: '不能为空',
            trigger: 'blur',
        ...
        >
          ...
          <!--<span style="margin-right: 5px;font-weight:bold">:</span>-->
          <el-date-picker size="small"
                          v-model="dynamicValidateForm.secondEndTime"
                          type="datetime"
                          placeholder="选择日期时间"
                          :picker-options="startDateDisabled"
                          >
      ...
      <div class="param-item">
        ...
        >
          <el-radio-group v-model="dynamicValidateForm.status" @change="partChange">
      ...
      <div class="param-item">
        <el-form-item
          label="三级类目" prop="threeCategories"
          :rules="{
            required: true,
            message: '不能为空',
            trigger: 'change',
        ...
        >
          <!--<div class="param-label">項目</div>-->
          <!--<span style="margin-right: 5px;font-weight:bold">:</span>-->
          <el-select v-model="dynamicValidateForm.threeCategories" size="small" placeholder="请选择" style="width: 300px">
            <el-option :label="item.label" :value="item.value" v-for="(item,index) in threeCategoriesArr" :key="index"></el-option>
          </el-select>
        </el-form-item>
      </div>
