...
layui.define("layer", function(e) {
    ...
    p.prototype.initIE = function() {
        ...
        t.elem.next().hasClass(c) || (e.elemFile.wrap(a),
        t.elem.next("." + c).append(function() {
            var e = [];
    ...
    p.prototype.upload = function(e, t) {
        var n, o = this, l = o.config, r = o.elemFile[0], u = function() {
            ...
            if ("choose" !== t && !l.auto || (l.choose && l.choose(g),
            "choose" !== t))
...
layui.define("jquery", function(e) {
    ...
    p.prototype.render = function() {
        ...
        t.range) {
            ...
            t.value = "object" == typeof t.value ? Math.min(t.value[0], t.value[1]) : t.value,
            t.value = t.value > t.min ? t.value : t.min;
    ...
    p.prototype.slide = function(e, t, a) {
        var n = this
          ...
          , x = function(e, i) {
            ...
            t = T(p() - h[0].offsetTop - h.height()),
            a = l.range ? T(p() - h[1].offsetTop - h.height()) : 0) : s.find("." + d).css("left", e + "%"),
            t = t > 100 ? 100 : t,
            a = a > 100 ? 100 : a;
            var n = Math.min(t, a)
              , o = Math.abs(t - a);
        ...
        s.find("." + u).each(function(e) {
            ...
            t.on("mousedown", function(i) {
                ...
                var a = t.parent()[0].offsetLeft
                  , n = i.clientX;
                "vertical" === l.type && (a = p() - t.parent()[0].offsetTop - h.height(),
                n = i.clientY);
                var r = function(i) {
                    i = i || window.event;
...
layui.define("layer", function(e) {
    ...
    u.prototype.val = function(e, t) {
        ...
        a.each(function(e, a) {
            ...
            layui.each(t, function(e, i) {
                ...
                a[0] && (t = a[0].type,
                "checkbox" === t ? a[0].checked = i : "radio" === t ? a.each(function() {
    ...
    u.prototype.render = function(e, t) {
        var n = this
          ...
          , d = {
            select: function() {
                var e, t = "请选择", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "", f = u.find("select"), v = function(t, l) {
                    i(t.target).parent().hasClass(n) && !l || (i("." + a).removeClass(a + "ed " + a + "up"),
                    e && d && e.val(d)),
                    e = null
                }, y = function(t, u, f) {
                    var y, p = i(this), m = t.find("." + n), k = m.find("input"), x = t.find("dl"), g = x.children("dd"), b = this.selectedIndex;
                    if (!u) {
                        var C = function() {
                                ...
                                var r = function() {
                                    ...
                                    if (x.children("dd." + o)[0] && "next" === i) {
                                        var t = x.children("dd:not(." + o + ",." + c + ")")
                                          , n = t.eq(0).index();
                                        if (n >= 0 && n < e.index() && !t.hasClass(s))
                                            return t.eq(0).prev()[0] ? t.eq(0).prev() : x.children(":last")
                                    }
        ...
        if (layui.each(d, function(e, l) {
            ...
            layui.each(c, function(e, i) {
                ...
                if (a[i]) {
                    ...
                    if (f = f || a[i][1],
                    c)
                        return "tips" === u ? t.tips(f, function() {
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    j.prototype.render = function() {
        ...
        if (a.elem = t(a.elem),
        a.where = a.where || {},
        a.id = a.id || a.elem.attr("id") || a.index,
        a.request = t.extend({
            pageName: "page",
            limitName: "limit"
        }, a.request),
        ...
        a.height = R.height() - e.fullHeightGap),
        e.setInit();
        var l = a.elem
          , n = l.next("." + f)
        ...
        e.layTool = o.find(p),
        e.layBox = o.find(v),
        e.layHeader = o.find(g),
        e.layMain = o.find(x),
        e.layBody = o.find(b),
        e.layFixed = o.find(k),
        e.layFixLeft = o.find(C),
        e.layFixRight = o.find(w),
        e.layTotal = o.find(T),
        e.layPage = o.find(A),
        e.renderToolbar(),
        e.fullSize(),
        ...
        a.url) {
            ...
            t.ajax({
                ...
                success: function(t) {
                    ...
                    i.layMain.html('<div class="' + h + '">' + (t[n.msgName] || "返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode) + "</div>")) : (i.renderData(t, e, t[n.countName]),
                    o(),
                ...
                error: function(e, t) {
                    i.layMain.html('<div class="' + h + '">数据接口请求异常：' + t + "</div>"),
                    i.renderForm(),
                    i.setColsWidth()
                }
            })
    ...
    j.prototype.renderData = function(e, n, o, r) {
        ...
        c.layMain.find("." + h).remove(),
        c.layMain.append('<div class="' + h + '">' + s.text.none + "</div>")) : (m(),
        c.renderTotal(u),
    ...
    j.prototype.sort = function(e, i, a, l) {
        ...
        try {
            ...
            c.layHeader.find("th").find(L).removeAttr("lay-sort"),
        ...
        "asc" === i ? r = layui.sort(f, n) : "desc" === i ? r = layui.sort(f, n, !0) : (r = layui.sort(f, d.config.indexName),
        delete c.sortKey),
        u[y.response.dataName] = r,
        c.renderData(u, c.page, c.count, !0),
        l && layui.event.call(e, s, "sort(" + h + ")", {
            field: n,
            type: i
        })
    }
    ...
    j.prototype.loading = function(e) {
        ...
        delete i.layInit,
        i.layBox.find(m).remove()) : (i.layInit = t(['<div class="layui-table-init">', '<i class="layui-icon layui-icon-loading layui-icon"></i>', "</div>"].join("")),
    ...
    j.prototype.fullSize = function() {
        ...
        t.fullHeightGap && (a = R.height() - t.fullHeightGap,
        a < 135 && (a = 135),
        t.elem.css("height", a)),
    ...
    j.prototype.scrollPatch = function() {
        ...
        var r = e.layMain.height()
          , d = r - l;
        e.layFixed.find(b).css("height", i.height() > d ? d : "auto"),
        e.layFixRight[n > 0 ? "removeClass" : "addClass"](y),
        e.layFixRight.css("right", a - 1)
    }
    ,
    j.prototype.events = function() {
        var e, a = this, o = a.config, c = t("body"), u = {}, h = a.layHeader.find("th"), f = ".layui-table-cell", p = o.elem.attr("lay-filter");
        a.layTool.on("click", "*[lay-event]", function(e) {
            ...
            H.trigger("table.tool.panel.remove"),
            l.close(a.tipsIndex),
            c) {
            case "LAYTABLE_COLS":
                u({
        ...
        h.on("mousemove", function(e) {
            var i = t(this)
              , a = i.offset().left
              , l = e.clientX - a;
            i.data("unresize") || u.resizeStart || (u.allowResize = i.width() - l <= 10,
            c.css("cursor", u.allowResize ? "col-resize" : ""))
        }).on("mouseleave", function() {
            t(this);
            ...
            if (u.allowResize) {
                ...
                a.getCssRule(l, function(e) {
                    ...
                    u.rule = e,
                    u.ruleWidth = parseFloat(t),
                    u.minWidth = i.data("minwidth") || o.cellMinWidth
                })
            }
        }),
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
            ...
            a.syncCheckAll()),
            layui.event.call(this, s, "checkbox(" + p + ")", v.call(this, {
                checked: n,
                type: o ? "all" : "one"
            }))
        }),
        a.elem.on("click", 'input[lay-type="layTableRadio"]+', function() {
            ...
            layui.event.call(this, s, "radio(" + p + ")", v.call(this, {
                checked: i
            }))
        }),
        ...
        a.layBody.on("change", "." + S, function() {
            var e = t(this)
              ...
              , o = d.cache[a.key][n];
            o[l] = i,
            layui.event.call(this, s, "edit(" + p + ")", v.call(this, {
                value: i,
                field: l
            }))
        }).on("blur", "." + S, function() {
        ...
        a.layBody.on("click", "td", function() {
            ...
            if (!e.data("off") && i) {
                ...
                return l[0].value = e.data("content") || a.text(),
                e.find("." + S)[0] || e.append(l),
                void l.focus()
            }
